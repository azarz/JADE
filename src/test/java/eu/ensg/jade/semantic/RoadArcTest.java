...
public class RoadArcTest {
	...
	public void testAngleBetweenRoads(){
		...
		assertEquals(RoadArc.angleBetweenRoads(lsAB, lsAB),0,1);
		assertEquals(RoadArc.angleBetweenRoads(lsAB, lsAC),90,1);
		assertEquals(RoadArc.angleBetweenRoads(lsAC, lsAB),90,1);
		assertEquals(RoadArc.angleBetweenRoads(lsAB, lsAD),180,1);
		assertEquals(RoadArc.angleBetweenRoads(lsAB, lsAE),90,1);
	}
